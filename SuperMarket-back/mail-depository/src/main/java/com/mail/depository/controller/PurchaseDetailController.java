...
public class PurchaseDetailController {
    ...
    //@RequiresPermissions("depository:purchasedetail:info")
     ...
     */
    @RequestMapping("/save")
    //@RequiresPermissions("depository:purchasedetail:save")
    ...
    //@RequiresPermissions("depository:purchasedetail:update")
    ...
    //@RequiresPermissions("depository:purchasedetail:delete")
