...
export const reqgetCategoryList = () => req.get(`/product/category/list/tree`);
...
export const reqSearchInfo = (params) =>
  req.get('/search/user/sku/list', { params });
...
export const reqOrderInfo = () =>
  req({ url: '/order/auth/trade', method: 'get' });
...
export const reqPayInfo = (orderId) =>
  req({ url: `/payment/weixin/createNative/${orderId}`, method: 'get' });

//获取支付订单状态
//URL:/api/payment/weixin/queryPayStatus/{orderId}  get
export const reqPayStatus = (orderId) =>
  req({ url: `/payment/weixin/queryPayStatus/${orderId}`, method: 'get' });

//获取个人中心的数据
//api/order/auth/{page}/{limit}  get
export const reqMyOrderList = (page, limit) =>
  req({ url: `/order/auth/${page}/${limit}`, method: 'get' });
