        ...
        <transition name="sort">
          <div class="sort" v-show="show">
            <div class="all-sort-list2" @click="goSearch">
              <div class="item" v-for="(c1, index) in categoryList" :key="c1.catId">
                <h3 :class="{ cur: currentIndex == index }" @mouseenter="changeIndex(index)">
                  <a :data-categoryName="c1.name" :data-category1Id="c1.catId">{{ c1.name }}</a>
                </h3>
                <div class="item-list clearfix" :style="{ display: currentIndex == index ? 'block' : 'none' }">
                  <div class="subitem">
                    <dl class="fore" v-for="(c2, index) in c1.children" :key="c2.catId">
                      <dt>
                        <a :data-categoryName="c2.name" :data-category2Id="c2.catId">{{ c2.name }}</a>
                      </dt>
                      <dd>
                        <em v-for="(c3, index) in c2.children" :key="c3.catId">
                          <a :data-categoryName="c3.name" :data-category3Id="c3.catId">{{ c3.name }}</a>
                        </em>
                      </dd>
                    </dl>
                  </div>
