<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="pic" header-align="center" align="center" label="图片地址">
      </el-table-column>
      ...
      <el-table-column prop="clickCount" header-align="center" align="center" label="点击数">
      </el-table-column>
      <el-table-column prop="url" header-align="center" align="center" label="广告详情连接地址">
      </el-table-column>
      ...
      <el-table-column prop="publisherId" header-align="center" align="center" label="发布者">
      </el-table-column>
      <el-table-column prop="authId" header-align="center" align="center" label="审核者">
      </el-table-column>
