<template>
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;">
      ...
      <el-table-column prop="fullPrice" header-align="center" align="center" label="满多少">
      </el-table-column>
      <el-table-column prop="reducePrice" header-align="center" align="center" label="减多少">
      </el-table-column>
      <el-table-column prop="addOther" header-align="center" align="center" label="是否参与其他优惠">
      </el-table-column>
