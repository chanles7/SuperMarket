    ...
    return {
      ...
      dataRule: {
        ...
        finishOvertime: [
          {
            required: true,
            message: "自动完成交易时间，不能申请退货（天）不能为空",
            trigger: "blur",
          },
        ],
        commentOvertime: [
        ...
        memberLevel: [
          {
            required: true,
            message:
              "会员等级【0-不限会员等级，全部通用；其他-对应的其他会员等级】不能为空",
            trigger: "blur",
          },
        ],
      },
