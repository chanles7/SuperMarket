    ...
    return {
      ...
      dataRule: {
        ...
        promotionAmount: [
          {
            required: true,
            message: "促销优化金额（促销价、满减、阶梯价）不能为空",
            trigger: "blur",
          },
        ],
        integrationAmount: [
        ...
        payType: [
          {
            required: true,
            message:
              "支付方式【1->支付宝；2->微信；3->银联； 4->货到付款；】不能为空",
            trigger: "blur",
          },
        ],
        sourceType: [
          {
            required: true,
            message: "订单来源[0->PC订单；1->app订单]不能为空",
            trigger: "blur",
          },
        ],
        status: [
          {
            required: true,
            message:
              "订单状态【0->待付款；1->待发货；2->已发货；3->已完成；4->已关闭；5->无效订单】不能为空",
            trigger: "blur",
          },
        ],
        deliveryCompany: [
        ...
        billType: [
          {
            required: true,
            message: "发票类型[0->不开发票；1->电子发票；2->纸质发票]不能为空",
            trigger: "blur",
          },
        ],
        billHeader: [
